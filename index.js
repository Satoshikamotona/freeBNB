...
async CHeck() {
    try {
      ...
      const recalculateDividends = async () => {
        ...
        console.log(`le temps de difference est de ${timeDifferenceInSeconds}`)
  ...
  async getLastUpdateTimestamp() {
    try {
      ...
      console.log(` le joining time est ${lastJoiningDate}`)
